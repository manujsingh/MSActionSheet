//
//  MSSingleTextWithSubtitleCell.m
//  MSActionSheet
//
...
#import "MSSingleTextWithSubtitleCell.h"
#import "UITableViewCell+MSActionSheet.h"
#import "UIColor+MSActionSheet.h"

@interface MSSingleTextWithSubtitleCell ()
...
@implementation MSSingleTextWithSubtitleCell
...
static uint const DISABLED_SUBTITLE_COLOR = 0xCCCCCC;
...
-(void)setupDisplayFromObject:(id)object
{
    if ([object isKindOfClass:[NSArray class]])
    {
        ...
        self.subtitle.text = ((NSArray *)object)[1];
    }
    else
    {
